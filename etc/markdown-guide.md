...
- [GitHub Markdown 가이드](#github-markdown-가이드)
  - [목차](#목차)
  - [1. 제목 (Headings)](#1-제목-headings)
  - [2. 텍스트 강조](#2-텍스트-강조)
  - [3. 목록 (Lists)](#3-목록-lists)
    - [순서 없는 목록 (Unordered List)](#순서-없는-목록-unordered-list)
    - [순서 있는 목록 (Ordered List)](#순서-있는-목록-ordered-list)
    - [작업 목록 (Task List)](#작업-목록-task-list)
  - [4. 링크 \& 이미지](#4-링크--이미지)
    - [링크](#링크)
    - [이미지](#이미지)
  - [5. 코드 (Code)](#5-코드-code)
    - [인라인 코드](#인라인-코드)
    - [코드 블록 (Fenced Code Block)](#코드-블록-fenced-code-block)
  ...
  - [11. GitHub 특화 요소](#11-github-특화-요소)
    - [사용자/팀 멘션](#사용자팀-멘션)
    - [Issue · PR 참조](#issue--pr-참조)
    - [커밋 참조](#커밋-참조)
    - [키보드 단축키 표시](#키보드-단축키-표시)
    - [이모지](#이모지)
  - [12. Mermaid 다이어그램](#12-mermaid-다이어그램)
  - [13. 알림 (Alerts)](#13-알림-alerts)
  - [기본 문법](#기본-문법)
  - [알림 유형별 사용법](#알림-유형별-사용법)
    - [1. NOTE](#1-note)
    - [2. TIP](#2-tip)
